...
| **0015** — Contador por empresa, furo aceito, número nunca reusado | **APLICÁVEL** | §7.4. Escopo `(empresa, ano)`, que é literalmente o que a `Decision` declara (*"o contrato inclui o ano no escopo"*); criações concorrentes **não esperam**; furo aceito; e as **duas unidades sequenciais** existem para que o número **nunca seja reusado, nem por criação abortada** |
