...
<!-- ESTADO:F4:INICIO -->
> ✅ **concluída** — 43/43 tasks
>
> ✅ `fundacao-bancaria/v1` — 14/14 tasks
> ✅ `emissao-e-conciliacao/v1` — 17/17 tasks
> ✅ `webhook-e-carne/v1` — 12/12 tasks
<!-- ESTADO:F4:FIM -->
...
<!-- ESTADO:F7:INICIO -->
> 🔄 **em andamento** — 1 de 2 fatias · 12/13 tasks
>
> ✅ `publicacao-e-backup/v1` — 11/11 tasks
> 🔄 `virada-e-desinstalacao/v1` — 1/2 tasks
<!-- ESTADO:F7:FIM -->
