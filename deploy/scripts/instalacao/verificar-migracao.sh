...
#   um schema íntegro.
readonly TABELAS_DE_NEGOCIO_ESPERADAS="negocio.acesso_usuario_app negocio.acesso_usuario_permissao negocio.certificado_do_provedor negocio.cobranca negocio.cobranca_derivada negocio.comodo negocio.conferencia_bancaria negocio.configuracao_de_mora negocio.conjunto negocio.contrato negocio.contrato_fiador negocio.emissao_em_lote negocio.entrega_da_noticia negocio.envio_de_cobranca negocio.evento_bancario negocio.fiador negocio.identidade_no_provedor negocio.imovel negocio.item_da_emissao_em_lote negocio.locador negocio.locatario negocio.politica_de_aviso negocio.portador_de_confirmacao"
