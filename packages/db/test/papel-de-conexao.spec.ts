 ...
 * da fatia `integracao-bancaria-autonoma` acrescentou UMA pela `0023`, e a T3 da fatia
 * `automacoes-agendadas` acrescenta UMA pela `0026`. O
 * papel da conexão — que é o que estes casos provam — não mudou: `sysloc_app` continua sem
 * privilégio, e a tabela nova continua pertencendo a `sysloc_migracao`. Declarar as vinte e três é a
