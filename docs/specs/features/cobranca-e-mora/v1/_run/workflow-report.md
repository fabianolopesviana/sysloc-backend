...
somadas: **`t10_sha` = `2a92b9dc63a5cdd275eb6d97517e1f6513f92e4b`** (tree
`1e0681eab850b00e1052a71be8a740ecb3fa3220`). Delta da T11 sobre `apps`/`packages`: **2 arquivos,
+1042/−5**.

> ⚠️ **O `t10_sha` é um commit solto, sem referência de branch** — o `git gc` pode podá-lo se a pausa
> for longa. Se `git cat-file -e 2a92b9dc…` falhar na retomada, **recrie-o**, que é barato e
